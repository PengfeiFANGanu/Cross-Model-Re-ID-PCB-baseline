...
if dataset == 'sysu':
    ...
    if len(args.resume) > 0:
        ...
        # model_path = checkpoint_path + 'sysu_agw_p4_n4_lr_0.1_seed_0_best.t'
        # model_path = checkpoint_path + 'sysu_agw_p4_n4_lr_0.1_seed_0_mode_all_alpha_1.0_best.t'

        #indoor
        model_path = checkpoint_path + 'sysu_agw_p4_n4_lr_0.1_seed_2_mode_indoor_alpha_1.0_best.t'
    ...
    for trial in range(10):
        test_trial = trial +1
        #model_path = checkpoint_path +  args.resume
        # model_path = checkpoint_path + 'regdb_awg_p4_n4_lr_0.1_seed_0_trial_{}_best.t'.format(test_trial)


        # model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_v2i_best.t'.format(test_trial)
        # model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_v2i_alpha_1.0_best.t'.format(test_trial)

        # model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_i2v_best.t'.format(test_trial)

        model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_i2v_alpha_1.0_best.t'.format(test_trial)


        # if args.modality == 'v2i':
        #     model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_v2i_alpha_1.0_best.t'.format(test_trial)
        # else:
        #     model_path = checkpoint_path + 'regdb_agw_p4_n4_lr_0.1_seed_0_trial_{}_modality_i2v_alpha_1.0_best.t'.format(test_trial)
